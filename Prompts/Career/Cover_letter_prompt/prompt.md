...
**Structure:** The framework I've decided to use is B-A-B because all the user needs to do is request the cover letter, give examples of work experience and skills, and let the AI write the cover letter
**Technique:** Zero-Shot
---
## The Prompt
**Objective:**
